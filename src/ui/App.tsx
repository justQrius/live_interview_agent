...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 text-text-primary transition-colors duration-300">
        ...
        <header className="mb-6 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-surface border border-border rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-text-secondary transition-all shadow-sm hover:shadow active:scale-95"
